...
namespace LeagueApplication1
{
	public class PreviousExpanded
	{
		...
		public PreviousExpanded(string champPlayed, int level, bool result, string gold, string creepScore, List<string> itemNameList,
			List<string> summonerSpellList, string imagePath = "", string gameMode = "", Game thisGame = null)
		{
			ThisGame = thisGame;
			Name = champPlayed;
			Level = level;
